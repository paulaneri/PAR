<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- mujer -->
        <li class="<?php if ($page_name == 'mujer') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/mujer">
            <i class="fa fa-group"></i>
                <span><?php echo get_phrase('mujer'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/teacher">
                ...
                <!-- TC -->
                <li class="<?php if ($page_name == 'tc') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/tc">
                        <i class="entypo-chat"></i>
                        <span><?php echo get_phrase('Tabajo de campo'); ?></span>
                    </a>
                </li>
                <!-- cd -->
                <li class="<?php if ($page_name == 'cd') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/cd">
                        <i class="entypo-home"></i>
                        <span><?php echo get_phrase('Centro de día'); ?></span>
                    </a>
                </li>
