		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/tc/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('observamos');?></label>

						<div class="col-sm-5">
								<div class="box closable-chat-box">
										<div class="box-content padded">
														<div class="chat-message-box">
														<textarea name="observamos" id="ttt" rows="5" class="form-control"
															><?php echo $row['observamos'];?></textarea>
														</div>
										</div>
								</div>
						</div>
