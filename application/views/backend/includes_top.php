...
<link rel="stylesheet" href="https://github.com/ultraleettech/ultraselect/blob/master/dist/jquery.ultraselect.css" >
...
<link rel="stylesheet" href="assets/js/bootstrap-select.css">
...
<script src="<?php echo base_url();?>assets/js/jquery.tabledit.min.js" type="text/javascript"></script>
<!--Amcharts-->
...
<script>
    ...
    {
        var chk=confirm("Seguro que quieres borrar?!");
        if(chk)
        {
          return true;
        }
